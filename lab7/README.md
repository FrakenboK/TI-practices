...
Также можно воспользоваться языком R и функцией `s3_bucket` из пакета
`arrow`:
...
```
    ...
    [1] "archive.zip"            "hh_recsys_vacancies.pq" "tm_data.pqt"           
    [4] "yaqry_dataset.pqt"     
...
Исходящий трафик будем также искать по регулярным выражением. Источник
должен быть внутренним хостом, а получатель - внешним:
...
Входящий трафик будем также искать по регулярным выражением. Источник
должен быть внешним хостом, а получатель - внутренним:
